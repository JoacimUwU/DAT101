...
printOut(`Part 2 - Total inches: ${inches.toFixed(2)}`);
...
printOut(`Part 3 - Total minutes: ${totalMinutes.toFixed(2)}`);
...
printOut(`Part 4 - Time: ${daysPart} days, ${hoursPart} hours, ${minutesPart} minutes, ${secondsPart} seconds`);
...
printOut(`Part 5 - USD to NOK: ${nokAmount.toFixed(0)}, NOK to USD: ${usdValue.toFixed(0)}`);
...
printOut(`Part 6 - Total characters: ${text.length}`);

// Log the 19th character
printOut(`Part 6 - 19th character: ${text.charAt(18)}`);

// Log 8 characters starting at position 35
printOut(`Part 6 - Characters from position 35: ${text.slice(34, 42)}`);

// Find the starting index of the word "earth"
printOut(`Part 6 - Index of 'earth': ${text.indexOf("earth")}`);

printOut(newLine);

printOut("--- Part 7 ----------------------------------------------------------------------------------------------");
// Part 7: Compare values and log results
printOut("Part 7 - Comparisons:");
...
printOut("Part 8 - Type Conversion:");
...
printOut(`Part 9 - Random number between 1 and 360: ${randomNumber}`);
...
// Log the result
printOut(`Part 10 - ${totalDays} days = ${weeks} weeks and ${remainingDays} days`);
